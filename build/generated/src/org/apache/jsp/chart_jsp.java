...
ResultSet resultSet = null;
      ...
      out.write("                                <li><a href=\"AESupload.jsp\">AES Upload</a></li>\n");
      out.write("                                <li><a href=\"chart.jsp\">CHARTS</a></li>\n");
      out.write("\t\t\t</ul>\n");
      out.write("        </div>\n");
      out.write("\t</div>\n");
      out.write("</div>\n");
      ...
      out.write("\t<h2 style=\"font-size: x-large\">CHART FOR AES - DES</h2><br>\n");
      out.write("</div><br>\n");
      out.write("\n");
...
while(resultSet.next()){
           ...
           // --- Create two Java Arrays  
            ...
            String aes = resultSet.getString("yaxis");
            HttpSession session91=request.getSession(false);
            String des=resultSet.getString("xaxis") ;
            float aes1=(Float.parseFloat(aes)/1000);
            float des1=(Float.parseFloat(des)/10);
            months.add("AES ");
            users.add(aes1);
            months.add("DES ");
            users.add(des1);
...
e.printStackTrace();
      ...
      out.write("      \"title\": {\n");
      out.write("        \"text\": \"AES-DES Comparison Graph For Retrivel Time\"\n");
      out.write("      },\n");
      out.write("      \"scale-x\": {\n");
      out.write("        \"labels\": monthData,\n");
      out.write("      },\n");
      out.write("      \"scale-y\": {\n");
      out.write("        \"min-value\":0.0001,\n");
      ...
      out.write("                        <h1>AES-DES Comparison Graph For Retrivel Time</h1>  \n");
