...
<div id="header">
	<div id="menu">
        <div>
			...
			<ul>
				<li><a href="home.jsp">TAES-DES</a></li>
				<li><a href="home.jsp">IBE-HASH</a></li>
				<li><a href="home.jsp">TAES-BLOW</a></li>
				<li><a href="home.jsp">AES-FCS</a></li>
			</ul>
        </div>
	</div>
</div>
...
<h2 style="font-size: x-large">Cloud Data Security Using Encryption</h2><br>
</div><br>
	...
	<div style="font-size: 15px;">
		<div class="post" id="ulogin">
			...
			<h2 class="title"style="color: #EAF2F8">ADMIN LOGIN </h2>        
                <form action="MasterLogin" name="ulogin" method="post" onsubmit="return validation()"> 
