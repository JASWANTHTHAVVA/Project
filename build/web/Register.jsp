...
<div id="header">
	<div id="menu">
		...
		<li><a href="admin.jsp">Admin</a></li>
                <li><a href="TAES.jsp">User</a></li>
                <li><a class="current_page_item" href="Register.jsp">User Registration</a></li>
			</ul>
        </div>
	</div>
</div>
		...
		<div class="post" id="ulogin">
            <center>
				<h2 class="title"style="color: coral">USER REGISTRATION </h2>
                    ...
                    <form action="Register" name="ureg" method="post" onsubmit="return validation()"> 
