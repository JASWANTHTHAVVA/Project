...
<div id="header">
	<div id="menu">
		...
		<li><a href="AESupload.jsp">Upload Aes</a></li>
                <li><a class="current_page_item" href="chart.jsp">Chart</a></li>
			</ul>
        </div>
	</div>
</div>
	...
	<div style="font-size: 15px;">
		<div class="post" id="ulogin">
			...
			<h2 class="title"style="color: #EAF2F8">Upload Data </h2>        
                <form action="Uploads" name="ulogin" method="post" onsubmit="return validation()"> 
