...
<div id="header">
	<div id="menu">
		...
		<li><a href="admin.jsp">Admin</a></li>
                <li><a href="BLOW.jsp">User</a></li>
                <li><a class="current_page_item" href="bregister.jsp">User Registration</a></li>
			</ul>
        </div>
	</div>
</div>
		...
		<div class="post" id="ulogin">
            <center>
				<h2 class="title"style="color: coral">USER REGISTRATION </h2>
                    ...
                    <form action="BRegister" name="ureg" method="post" onsubmit="return validation()"> 
