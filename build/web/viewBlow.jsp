...
<div id="header">
	<div id="menu">
        <div>
			<ul>
                    <li><a href="viewBlow.jsp">View Files</a></li>
                    <li><a href="BlowDecrypt.jsp">Decrypt</a></li>
			</ul>
        </div>
	</div>
</div>
                    ...
                    <center>
                        ...
                        <table style="border-style: solid ">
                            <tr style="background-color: #897B7B">
                                <td >FILENAME</td><td>KEY</td><td>ALGORITHM</td>
                            </tr>
						   <%
...
String sql ="select * from buploads ";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
        
   
		 String filename=resultSet.getString("fname");
		String size=resultSet.getString("bkey");
		 String id=resultSet.getString("algorithm");
						   %>
                            <tr>
                                <td><%=filename%></td><td><%=size%></td><td><%=id%></td>
                            </tr>
                            <%
}
connection.close();
