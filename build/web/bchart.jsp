        ...
        <div>
			<ul>
				<li><a href="home.jsp">Home</a></li>
                                <li><a href="bupload.jsp">Blow Upload</a></li>
                                <li><a href="bchart.jsp">CHARTS</a></li>
			</ul>
        </div>
	</div>
</div>
<!-- end header -->
<div id="logo">
	<h2 style="font-size: x-large">CHART FOR AES - Blow Fish</h2><br>
</div><br>
...
String sql ="select * from graph where id=3";
...
while(resultSet.next()){
           ...
           // --- Create two Java Arrays  
            ...
            float des1=(Float.parseFloat(des)/100);
            months.add("AES ");
            users.add(des1);
            months.add("Blow Fish ");
            users.add(aes1);
        %>  
...
window.onload = function() {
  zingchart.render({
    ...
    data: {
      ...
      "bar-width":"25%",
      "title": {
        "text": "AES-bowfish Comparison Graph For Retrivel Time"
      },
      "scale-x": {
        "labels": monthData,
      },
	...
	<div style="font-size: 15px;">
		<div class="post" id="ulogin">
			...
			<h2 class="title"style="color: coral">GRAPH</h2> 
                        <h1>AES-Blowfish Comparison Graph For Retrivel Time</h1>  
                        <div id="myChart"></div>
