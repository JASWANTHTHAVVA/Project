...
<div id="header">
	<div id="menu">
		...
		<li><a href="admin.jsp">Admin</a></li>
                <li><a href="IBE.jsp">User</a></li>
                <li><a class="current_page_item" href="iberegister.jsp">User Registration</a></li>
			</ul>
        </div>
	</div>
</div>
<!-- end header -->
<div id="logo">
	<h2 style="font-size: x-large">Registering Of New User</h2><br>
</div><br>
		...
		<div class="post" id="ulogin">
            <center>
				<h2 class="title"style="color: coral">USER REGISTRATION </h2>
                    ...
                    <form action="IBERegister" name="ureg" method="post" onsubmit="return validation()"> 
						...
						<input type="text" name="mobile" placeholder="Enter your mobile no" maxlength="10"><br></br>
                                         ...
                                         <option  value="taes">TAES-DES</option>
                                            <option value="ibe">IBE-HASH</option>
                                           <option  value="blow">TAES-BLOW</option>
