 ...
 * @author ANAND
 */
public class FDecrypt extends HttpServlet {
      ...
      public void doPost(HttpServletRequest request, HttpServletResponse response)
		   ...
		   String strQuery= ""; 
			...
			conn = DriverManager.getConnection(url+dbName,userName,password);
             ...
             strQuery="select * from fupload where fname='"+name+"' ";
					...
					while(rs.next())
					 ...
					 pwd=rs.getString("file_key");
                                       ...
                                       RequestDispatcher rd=request.getRequestDispatcher("/Fdecrypt.jsp");
						rd.forward(request, response);
						System.out.println("ret-forward");
                                       }
                                      else if(country.equalsIgnoreCase("fcs")){
                                        AESenc en=new AESenc();
                                        state=en.decrypt(email,pwd);
