...
//					//npass=k+pass;
//					 
 strQuery="insert into bregister (name,username,password,mail,mobile,algorithm) values('"+user+"','"+name+"','"+pwd+"','"+email+"','"+gender+"','"+state+"')";
...
st.executeUpdate(strQuery);
				...
				RequestDispatcher rd=request.getRequestDispatcher("/BLOW.jsp");
