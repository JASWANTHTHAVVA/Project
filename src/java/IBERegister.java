 ...
 * @author ANAND
 */
public class IBERegister extends HttpServlet {
...
String keey=""+nam[0]+ph[2]+nam[1]+ph[5]+em[1]+em[4]+nam[3]+ph[7]+em[0]+nam[4]+ph[5]+em[2]+pa[3]+pa[2]+pa[1]+pa[0];
					//npass=k+pass;
//					 
 strQuery="insert into iberegister (name,username,password,mail,mobile,country,algorithm,ikey) values('"+user+"','"+name+"','"+pwd+"','"+email+"','"+gender+"','"+country+"','"+state+"','"+keey+"')";
...
st.executeUpdate(strQuery);
				...
				RequestDispatcher rd=request.getRequestDispatcher("/IBE.jsp");
