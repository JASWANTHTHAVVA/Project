...
<div id="header">
	<div id="menu">
		...
		<li><a href="ibeupload.jsp">Upload IBE</a></li>
                <li><a class="current_page_item" href="ibechart.jsp">Chart</a></li>
			</ul>
        </div>
	</div>
</div>
...
<div id="page">
	...
	<div style="font-size: 15px;">
		...
		<h2 class="title"style="color: #EAF2F8">Upload Data </h2>        
                <form action="IBEUpload" name="ulogin" method="post" onsubmit="return validation()"> 
