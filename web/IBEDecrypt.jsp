...
<div id="header">
	<div id="menu">
        <div>
			<ul>
				<li><a class="current_page_item" href="admin.jsp">Home</a></li>
	...
	<div style="font-size: 15px;">
		<div class="post" id="ulogin">
			...
			<h2 class="title"style="color: #EAF2F8">DECRYPT OF DATA </h2>        
                <form action="IBEDecrypt" name="ulogin" method="post" onsubmit="return validation()"> 
		<input type="text" name="fname" placeholder="Enter filename"><br></br>
                    <input type="text" name="users" placeholder="Enter Username"><br></br>
