        ...
        <div>
			<ul>
				<li><a href="home.jsp">Home</a></li>
                                <li><a href="ibeupload.jsp">IBE Upload</a></li>
                                <li><a href="ibechart.jsp">CHARTS</a></li>
			</ul>
        </div>
	</div>
</div>
<!-- end header -->
<div id="logo">
	<h2 style="font-size: x-large">CHART FOR IBE - HASH</h2><br>
</div><br>
...
String sql ="select * from graph where gname = 'second'";
...
window.onload = function() {
  zingchart.render({
    ...
    data: {
      ...
      "bar-width":"25%",
      "title": {
        "text": "IBE-HASH Minimum signin time verification"
      },
      "scale-x": {
        "labels": monthData,
      },
	...
	<div style="font-size: 15px;">
		<div class="post" id="ulogin">
			...
			<h2 class="title"style="color: coral">GRAPH</h2> 
                        <h1>IBE-HASH Minimum Siging Time Verification</h1>  
                        <div id="myChart"></div>
