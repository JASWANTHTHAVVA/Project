	...
	<div id="menu">
        <div>
			<ul>
				...
				<li><a href="IBE.jsp">Users</a></li>
				<li><a href="admin.jsp">Admin</a></li>
				<li><a href="iberegister.jsp">Register</a></li>
			</ul>
        </div>
	</div>
</div>
...
<h2 style="font-size: x-large">Identity Based Signature Over Hash Based Protocal</h2><br>
</div><br>
	...
	<div style="font-size: 15px;">
		<div class="post" id="ulogin">
			...
			<h2 class="title"style="color: #EAF2F8">USER LOGIN </h2>        
                <form action="IBELogin" name="ulogin" method="post" onsubmit="return validation()"> 
