        ...
        <div>
			<ul>
				<li><a href="home.jsp">Home</a></li>
                                <li><a href="AESupload.jsp">AES Upload</a></li>
...
<!-- end header -->
<div id="logo">
	<h2 style="font-size: x-large">CHART FOR AES - DES</h2><br>
</div><br>
...
window.onload = function() {
  zingchart.render({
    ...
    data: {
      ...
      "bar-width":"25%",
      "title": {
        "text": "AES-DES Comparison Graph For Retrivel Time"
      },
      "scale-x": {
        "labels": monthData,
      },
	...
	<div style="font-size: 15px;">
		<div class="post" id="ulogin">
			...
			<h2 class="title"style="color: coral">GRAPH</h2> 
                        <h1>AES-DES Comparison Graph For Retrivel Time</h1>  
                        <div id="myChart"></div>
