	...
	<div id="menu">
        <div>
			<ul>
				...
				<li><a href="BLOW.jsp">Users</a></li>
				<li><a href="admin.jsp">Admin</a></li>
				<li><a href="bregister.jsp">Register</a></li>
			</ul>
        </div>
	</div>
</div>
...
<h2 style="font-size: x-large">AES OVER BLOW FISH</h2><br>
</div><br>
	...
	<div style="font-size: 15px;">
		<div class="post" id="ulogin">
			...
			<h2 class="title"style="color: #EAF2F8">USER LOGIN </h2>        
                <form action="BLogin" name="ulogin" method="post" onsubmit="return validation()"> 
